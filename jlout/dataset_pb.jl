...
function meta(::Type{BondTopology})
    ProtoBuf.metalock() do
        if !isassigned(__meta_BondTopology)
            ...
            pack = Symbol[:atoms]
            allflds = Pair{Symbol,Union{Type,String}}[
                :atoms=>Base.Vector{Int32},
                :bonds=>Base.Vector{BondTopology_Bond},
                :smiles=>AbstractString,
                :bond_topology_id=>Int32,
                :score=>Float32,
                :is_starting_topology=>Bool,
            ]
            meta(
                target,
                BondTopology,
...
function meta(::Type{TopologyMatches})
    ProtoBuf.metalock() do
        if !isassigned(__meta_TopologyMatches)
            ...
            allflds =
                Pair{Symbol,Union{Type,String}}[:bond_topology=>Base.Vector{BondTopology}]
            meta(
                target,
                TopologyMatches,
                allflds,
...
function meta(::Type{Geometry})
    ProtoBuf.metalock() do
        if !isassigned(__meta_Geometry)
            ...
            allflds = Pair{Symbol,Union{Type,String}}[:atom_positions=>Base.Vector{
                Geometry_AtomPos,
            }]
            meta(
                target,
...
function meta(::Type{Properties_Errors})
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_Errors)
            ...
            allflds = Pair{Symbol,Union{Type,String}}[
                :error_frequencies=>Int32,
                :error_atomic_analysis=>Int32,
                :error_nmr_analysis_b3lyp_small_basis=>Int32,
                :error_nmr_analysis_b3lyp_large_basis=>Int32,
                :error_nmr_analysis_pbe0_small_basis=>Int32,
                :error_nmr_analysis_pbe0_large_basis=>Int32,
                :error_charge_analysis=>Int32,
                :error_energies_orbitals_pvtz=>Int32,
                :error_energies_orbitals_pvqz=>Int32,
                :error_energies_orbitals_pcvtz=>Int32,
                :error_excitation_energies=>Int32,
                :error_single_point_energies=>Int32,
                :error_inconsistent_molecule_energy_turbomole_mrcc=>Int32,
                :error_inconsistent_cation_energy_turbomole_mrcc=>Int32,
                :error_inconsistent_molecule_energy_turbomole_orca=>Int32,
                :error_inconsistent_cation_energy_turbomole_orca=>Int32,
                :error_normal_modes=>Int32,
                :error_rotational_modes=>Int32,
                :error_nsvho1=>Int32,
                :error_nsvho2=>Int32,
                :error_nsvho3=>Int32,
                :error_nsvneg=>Int32,
                ...
                :error_nsvego=>Int32,
                :error_nsvg09=>Int32,
                :error_during_merging=>AbstractString,
            ]
            meta(
                target,
                Properties_Errors,
...
mutable struct Properties_StringMolecularProperty <: ProtoType
    ...
    function Properties_StringMolecularProperty(; kwargs...)
        obj =
            new(meta(Properties_StringMolecularProperty), Dict{Symbol,Any}(), Set{Symbol}())
        values = obj.__protobuf_jl_internal_values
        symdict = obj.__protobuf_jl_internal_meta.symdict
        for nv in kwargs
            fldname, fldval = nv
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_StringMolecularProperty)
            __meta_Properties_StringMolecularProperty[] =
                target = ProtoMeta(Properties_StringMolecularProperty)
            allflds = Pair{Symbol,Union{Type,String}}[:value=>AbstractString]
            meta(
                target,
                Properties_StringMolecularProperty,
                allflds,
                ProtoBuf.DEF_REQ,
                ProtoBuf.DEF_FNUM,
                ProtoBuf.DEF_VAL,
...
mutable struct Properties_ScalarMolecularProperty <: ProtoType
    ...
    function Properties_ScalarMolecularProperty(; kwargs...)
        obj =
            new(meta(Properties_ScalarMolecularProperty), Dict{Symbol,Any}(), Set{Symbol}())
        values = obj.__protobuf_jl_internal_values
        symdict = obj.__protobuf_jl_internal_meta.symdict
        for nv in kwargs
            fldname, fldval = nv
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_ScalarMolecularProperty)
            __meta_Properties_ScalarMolecularProperty[] =
                target = ProtoMeta(Properties_ScalarMolecularProperty)
...
mutable struct Properties_MultiScalarMolecularProperty <: ProtoType
    ...
    function Properties_MultiScalarMolecularProperty(; kwargs...)
        obj = new(
            meta(Properties_MultiScalarMolecularProperty),
            Dict{Symbol,Any}(),
            Set{Symbol}(),
        )
        values = obj.__protobuf_jl_internal_values
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_MultiScalarMolecularProperty)
            __meta_Properties_MultiScalarMolecularProperty[] =
                target = ProtoMeta(Properties_MultiScalarMolecularProperty)
            pack = Symbol[:value]
...
mutable struct Properties_AtomicMolecularProperty <: ProtoType
    ...
    function Properties_AtomicMolecularProperty(; kwargs...)
        obj =
            new(meta(Properties_AtomicMolecularProperty), Dict{Symbol,Any}(), Set{Symbol}())
        values = obj.__protobuf_jl_internal_values
        symdict = obj.__protobuf_jl_internal_meta.symdict
        for nv in kwargs
            fldname, fldval = nv
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_AtomicMolecularProperty)
            __meta_Properties_AtomicMolecularProperty[] =
                target = ProtoMeta(Properties_AtomicMolecularProperty)
            pack = Symbol[:values, :precision]
            allflds = Pair{Symbol,Union{Type,String}}[
                :values=>Base.Vector{Float64},
                :precision=>Base.Vector{Float64},
            ]
            meta(
                target,
...
mutable struct Properties_Vector3DMolecularProperty <: ProtoType
    ...
    function Properties_Vector3DMolecularProperty(; kwargs...)
        obj = new(
            meta(Properties_Vector3DMolecularProperty),
            Dict{Symbol,Any}(),
            Set{Symbol}(),
        )
        values = obj.__protobuf_jl_internal_values
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_Vector3DMolecularProperty)
            __meta_Properties_Vector3DMolecularProperty[] =
                target = ProtoMeta(Properties_Vector3DMolecularProperty)
...
mutable struct Properties_VectorFrequentialProperty <: ProtoType
    ...
    function Properties_VectorFrequentialProperty(; kwargs...)
        obj = new(
            meta(Properties_VectorFrequentialProperty),
            Dict{Symbol,Any}(),
            Set{Symbol}(),
        )
        values = obj.__protobuf_jl_internal_values
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_VectorFrequentialProperty)
            __meta_Properties_VectorFrequentialProperty[] =
                target = ProtoMeta(Properties_VectorFrequentialProperty)
            allflds = Pair{Symbol,Union{Type,String}}[
                :magnitude=>Float64,
                :harmonic_intensity=>Float64,
                :normal_mode=>Float64,
            ]
            meta(
                target,
                Properties_VectorFrequentialProperty,
                allflds,
                ProtoBuf.DEF_REQ,
                ProtoBuf.DEF_FNUM,
                ProtoBuf.DEF_VAL,
...
mutable struct Properties_AtomicVectorFrequentialProperty <: ProtoType
    ...
    function Properties_AtomicVectorFrequentialProperty(; kwargs...)
        obj = new(
            meta(Properties_AtomicVectorFrequentialProperty),
            Dict{Symbol,Any}(),
            Set{Symbol}(),
        )
        values = obj.__protobuf_jl_internal_values
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_AtomicVectorFrequentialProperty)
            __meta_Properties_AtomicVectorFrequentialProperty[] =
                target = ProtoMeta(Properties_AtomicVectorFrequentialProperty)
            allflds = Pair{Symbol,Union{Type,String}}[:frequencies=>Base.Vector{
                Properties_VectorFrequentialProperty,
            }]
            meta(
                target,
                Properties_AtomicVectorFrequentialProperty,
                allflds,
                ProtoBuf.DEF_REQ,
                ProtoBuf.DEF_FNUM,
                ProtoBuf.DEF_VAL,
...
mutable struct Properties_Rank2MolecularProperty <: ProtoType
    ...
    function Properties_Rank2MolecularProperty(; kwargs...)
        obj =
            new(meta(Properties_Rank2MolecularProperty), Dict{Symbol,Any}(), Set{Symbol}())
        values = obj.__protobuf_jl_internal_values
        symdict = obj.__protobuf_jl_internal_meta.symdict
        for nv in kwargs
            fldname, fldval = nv
...
mutable struct Properties_Rank3MolecularProperty <: ProtoType
    ...
    function Properties_Rank3MolecularProperty(; kwargs...)
        obj =
            new(meta(Properties_Rank3MolecularProperty), Dict{Symbol,Any}(), Set{Symbol}())
        values = obj.__protobuf_jl_internal_values
        symdict = obj.__protobuf_jl_internal_meta.symdict
        for nv in kwargs
            fldname, fldval = nv
...
mutable struct Properties_NormalMode_AtomicDisplacement <: ProtoType
    ...
    function Properties_NormalMode_AtomicDisplacement(; kwargs...)
        obj = new(
            meta(Properties_NormalMode_AtomicDisplacement),
            Dict{Symbol,Any}(),
            Set{Symbol}(),
        )
        values = obj.__protobuf_jl_internal_values
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_NormalMode_AtomicDisplacement)
            __meta_Properties_NormalMode_AtomicDisplacement[] =
                target = ProtoMeta(Properties_NormalMode_AtomicDisplacement)
            allflds = Pair{Symbol,Union{Type,String}}[:x=>Float64, :y=>Float64, :z=>Float64]
            meta(
                target,
                Properties_NormalMode_AtomicDisplacement,
                allflds,
                ProtoBuf.DEF_REQ,
                ProtoBuf.DEF_FNUM,
                ProtoBuf.DEF_VAL,
...
function meta(::Type{Properties_NormalMode})
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_NormalMode)
            ...
            allflds = Pair{Symbol,Union{Type,String}}[:displacements=>Base.Vector{
                Properties_NormalMode_AtomicDisplacement,
            }]
            meta(
                target,
                Properties_NormalMode,
                allflds,
                ProtoBuf.DEF_REQ,
                ProtoBuf.DEF_FNUM,
                ProtoBuf.DEF_VAL,
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_CalculationStatistics)
            __meta_Properties_CalculationStatistics[] =
                target = ProtoMeta(Properties_CalculationStatistics)
            allflds = Pair{Symbol,Union{Type,String}}[
                :computing_location=>AbstractString,
                :timings=>AbstractString,
            ]
            meta(
                target,
                Properties_CalculationStatistics,
                allflds,
                ProtoBuf.DEF_REQ,
                ProtoBuf.DEF_FNUM,
                ProtoBuf.DEF_VAL,
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties_GaussianSanityCheck)
            __meta_Properties_GaussianSanityCheck[] =
                target = ProtoMeta(Properties_GaussianSanityCheck)
            allflds = Pair{Symbol,Union{Type,String}}[
                :energy_pbe0_6_311gd_diff=>Float32,
                :max_force=>Float32,
                :max_frequencies_diff=>Float32,
                :mean_frequencies_diff=>Float32,
                :max_intensities_diff=>Float32,
                :mean_intensities_diff=>Float32,
                :energy_hf_6_31gd_diff=>Float32,
                :max_dipole_components_diff=>Float32,
                :max_quadropole_components_diff=>Float32,
                :max_octopole_components_diff=>Float32,
            ]
            meta(
                target,
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_Properties)
            ...
            allflds = Pair{Symbol,Union{Type,String}}[
                ...
                :geometry_gradient_norms=>Properties_AtomicMolecularProperty,
                :harmonic_intensities=>Properties_MultiScalarMolecularProperty,
                :harmonic_frequencies=>Properties_MultiScalarMolecularProperty,
                :normal_modes=>Base.Vector{Properties_NormalMode},
                :single_point_energy_pbe0d3_6_311gd=>Properties_ScalarMolecularProperty,
                :single_point_energy_pbe0_6_311gd=>Properties_ScalarMolecularProperty,
                :single_point_energy_pbe0_6_311gd_mrcc=>Properties_ScalarMolecularProperty,
                :single_point_energy_pbe0_6_311gd_orca=>Properties_ScalarMolecularProperty,
                :single_point_energy_pbe0_6_311gd_cat=>Properties_ScalarMolecularProperty,
                :single_point_energy_pbe0_6_311gd_cat_mrcc=>Properties_ScalarMolecularProperty,
                :single_point_energy_pbe0_6_311gd_cat_orca=>Properties_ScalarMolecularProperty,
                :single_point_energy_pbe0_aug_pc_1=>Properties_ScalarMolecularProperty,
                :single_point_energy_hf_6_31gd=>Properties_ScalarMolecularProperty,
                :single_point_energy_b3lyp_6_31ppgdp=>Properties_ScalarMolecularProperty,
                :single_point_energy_b3lyp_aug_pcs_1=>Properties_ScalarMolecularProperty,
                :single_point_energy_pbe0_6_31ppgdp=>Properties_ScalarMolecularProperty,
                :single_point_energy_pbe0_aug_pcs_1=>Properties_ScalarMolecularProperty,
                :single_point_energy_hf_tzvp=>Properties_ScalarMolecularProperty,
                :single_point_energy_mp2_tzvp=>Properties_ScalarMolecularProperty,
                :single_point_energy_cc2_tzvp=>Properties_ScalarMolecularProperty,
                :single_point_energy_hf_3=>Properties_ScalarMolecularProperty,
                :single_point_energy_mp2_3=>Properties_ScalarMolecularProperty,
                :single_point_energy_hf_4=>Properties_ScalarMolecularProperty,
                :single_point_energy_mp2_4=>Properties_ScalarMolecularProperty,
                :single_point_energy_hf_34=>Properties_ScalarMolecularProperty,
                :single_point_energy_mp2_34=>Properties_ScalarMolecularProperty,
                :single_point_energy_hf_cvtz=>Properties_ScalarMolecularProperty,
                :single_point_energy_mp2ful_cvtz=>Properties_ScalarMolecularProperty,
                :single_point_energy_hf_2sp=>Properties_ScalarMolecularProperty,
                :single_point_energy_mp2_2sp=>Properties_ScalarMolecularProperty,
                :single_point_energy_ccsd_2sp=>Properties_ScalarMolecularProperty,
                :single_point_energy_ccsd_t_2sp=>Properties_ScalarMolecularProperty,
                :single_point_energy_hf_2sd=>Properties_ScalarMolecularProperty,
                :single_point_energy_mp2_2sd=>Properties_ScalarMolecularProperty,
                :single_point_energy_ccsd_2sd=>Properties_ScalarMolecularProperty,
                :single_point_energy_ccsd_t_2sd=>Properties_ScalarMolecularProperty,
                :single_point_energy_hf_3psd=>Properties_ScalarMolecularProperty,
                :single_point_energy_mp2_3psd=>Properties_ScalarMolecularProperty,
                :single_point_energy_ccsd_3psd=>Properties_ScalarMolecularProperty,
                :single_point_energy_atomic_b5=>Properties_ScalarMolecularProperty,
                :single_point_energy_atomic_b6=>Properties_ScalarMolecularProperty,
                :single_point_energy_eccsd=>Properties_ScalarMolecularProperty,
                :zpe_unscaled=>Properties_ScalarMolecularProperty,
                :homo_pbe0_6_311gd=>Properties_ScalarMolecularProperty,
                :lumo_pbe0_6_311gd=>Properties_ScalarMolecularProperty,
                :homo_pbe0_aug_pc_1=>Properties_ScalarMolecularProperty,
                :lumo_pbe0_aug_pc_1=>Properties_ScalarMolecularProperty,
                :homo_pbe0_6_31ppgdp=>Properties_ScalarMolecularProperty,
                :lumo_pbe0_6_31ppgdp=>Properties_ScalarMolecularProperty,
                :homo_pbe0_aug_pcs_1=>Properties_ScalarMolecularProperty,
                :lumo_pbe0_aug_pcs_1=>Properties_ScalarMolecularProperty,
                :homo_b3lyp_6_31ppgdp=>Properties_ScalarMolecularProperty,
                :lumo_b3lyp_6_31ppgdp=>Properties_ScalarMolecularProperty,
                :homo_b3lyp_aug_pcs_1=>Properties_ScalarMolecularProperty,
                :lumo_b3lyp_aug_pcs_1=>Properties_ScalarMolecularProperty,
                :homo_hf_6_31gd=>Properties_ScalarMolecularProperty,
                :lumo_hf_6_31gd=>Properties_ScalarMolecularProperty,
                :homo_hf_tzvp=>Properties_ScalarMolecularProperty,
                :lumo_hf_tzvp=>Properties_ScalarMolecularProperty,
                :homo_hf_3=>Properties_ScalarMolecularProperty,
                :lumo_hf_3=>Properties_ScalarMolecularProperty,
                :homo_hf_4=>Properties_ScalarMolecularProperty,
                :lumo_hf_4=>Properties_ScalarMolecularProperty,
                :homo_hf_cvtz=>Properties_ScalarMolecularProperty,
                :lumo_hf_cvtz=>Properties_ScalarMolecularProperty,
                :excitation_energies_cc2=>Properties_MultiScalarMolecularProperty,
                :excitation_oscillator_strengths_cc2=>Properties_MultiScalarMolecularProperty,
                :nmr_isotropic_shielding_pbe0_6_31ppgdp=>Properties_AtomicMolecularProperty,
                :nmr_isotropic_shielding_pbe0_aug_pcs_1=>Properties_AtomicMolecularProperty,
                :nmr_isotropic_shielding_b3lyp_6_31ppgdp=>Properties_AtomicMolecularProperty,
                :nmr_isotropic_shielding_b3lyp_aug_pcs_1=>Properties_AtomicMolecularProperty,
                :partial_charges_mulliken_pbe0_aug_pc_1=>Properties_AtomicMolecularProperty,
                :partial_charges_mulliken_hf_6_31gd=>Properties_AtomicMolecularProperty,
                :partial_charges_loewdin_pbe0_aug_pc_1=>Properties_AtomicMolecularProperty,
                :partial_charges_loewdin_hf_6_31gd=>Properties_AtomicMolecularProperty,
                :partial_charges_natural_nbo_pbe0_aug_pc_1=>Properties_AtomicMolecularProperty,
                :partial_charges_natural_nbo_hf_6_31gd=>Properties_AtomicMolecularProperty,
                :partial_charges_paboon_pbe0_aug_pc_1=>Properties_AtomicMolecularProperty,
                :partial_charges_paboon_hf_6_31gd=>Properties_AtomicMolecularProperty,
                :partial_charges_esp_fit_pbe0_aug_pc_1=>Properties_AtomicMolecularProperty,
                :partial_charges_esp_fit_hf_6_31gd=>Properties_AtomicMolecularProperty,
                :dipole_dipole_polarizability_pbe0_aug_pc_1=>Properties_Rank2MolecularProperty,
                :dipole_dipole_polarizability_hf_6_31gd=>Properties_Rank2MolecularProperty,
                :dipole_moment_pbe0_aug_pc_1=>Properties_Vector3DMolecularProperty,
                :dipole_moment_hf_6_31gd=>Properties_Vector3DMolecularProperty,
                :quadrupole_moment_pbe0_aug_pc_1=>Properties_Rank2MolecularProperty,
                :quadrupole_moment_hf_6_31gd=>Properties_Rank2MolecularProperty,
                :octopole_moment_pbe0_aug_pc_1=>Properties_Rank3MolecularProperty,
                :octopole_moment_hf_6_31gd=>Properties_Rank3MolecularProperty,
                :compute_cluster_info=>AbstractString,
                :symmetry_used_in_calculation=>Bool,
                :initial_geometry_energy=>Properties_ScalarMolecularProperty,
                :initial_geometry_gradient_norm=>Properties_ScalarMolecularProperty,
                :optimized_geometry_energy=>Properties_ScalarMolecularProperty,
                :optimized_geometry_gradient_norm=>Properties_ScalarMolecularProperty,
                :rotational_constants=>Properties_Vector3DMolecularProperty,
                :bond_separation_reaction_left=>Properties_StringMolecularProperty,
                :bond_separation_reaction_right=>Properties_StringMolecularProperty,
                :bond_separation_energy_atomic_b5=>Properties_ScalarMolecularProperty,
                :bond_separation_energy_atomic_b5_um=>Properties_ScalarMolecularProperty,
                :bond_separation_energy_atomic_b5_um_ci=>Properties_ScalarMolecularProperty,
                :bond_separation_energy_atomic_b6=>Properties_ScalarMolecularProperty,
                :bond_separation_energy_atomic_b6_um=>Properties_ScalarMolecularProperty,
                :bond_separation_energy_atomic_b6_um_ci=>Properties_ScalarMolecularProperty,
                :bond_separation_energy_eccsd=>Properties_ScalarMolecularProperty,
                :bond_separation_energy_eccsd_um=>Properties_ScalarMolecularProperty,
                :bond_separation_energy_eccsd_um_ci=>Properties_ScalarMolecularProperty,
                :atomization_energy_excluding_zpe_atomic_b5=>Properties_ScalarMolecularProperty,
                :atomization_energy_excluding_zpe_atomic_b5_um=>Properties_ScalarMolecularProperty,
                :atomization_energy_excluding_zpe_atomic_b5_um_ci=>Properties_ScalarMolecularProperty,
                :atomization_energy_excluding_zpe_atomic_b6=>Properties_ScalarMolecularProperty,
                :atomization_energy_excluding_zpe_atomic_b6_um=>Properties_ScalarMolecularProperty,
                :atomization_energy_excluding_zpe_atomic_b6_um_ci=>Properties_ScalarMolecularProperty,
                :atomization_energy_excluding_zpe_eccsd=>Properties_ScalarMolecularProperty,
                :atomization_energy_excluding_zpe_eccsd_um=>Properties_ScalarMolecularProperty,
                :atomization_energy_excluding_zpe_eccsd_um_ci=>Properties_ScalarMolecularProperty,
                :atomization_energy_including_zpe_atomic_b5=>Properties_ScalarMolecularProperty,
                :atomization_energy_including_zpe_atomic_b5_um=>Properties_ScalarMolecularProperty,
                :atomization_energy_including_zpe_atomic_b5_um_ci=>Properties_ScalarMolecularProperty,
                :atomization_energy_including_zpe_atomic_b6=>Properties_ScalarMolecularProperty,
                :atomization_energy_including_zpe_atomic_b6_um=>Properties_ScalarMolecularProperty,
                :atomization_energy_including_zpe_atomic_b6_um_ci=>Properties_ScalarMolecularProperty,
                :atomization_energy_including_zpe_eccsd=>Properties_ScalarMolecularProperty,
                :atomization_energy_including_zpe_eccsd_um=>Properties_ScalarMolecularProperty,
                :atomization_energy_including_zpe_eccsd_um_ci=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_0k_atomic_b5=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_0k_atomic_b5_um=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_0k_atomic_b5_um_ci=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_0k_atomic_b6=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_0k_atomic_b6_um=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_0k_atomic_b6_um_ci=>Properties_ScalarMolecularProperty,
                ...
                :enthalpy_of_formation_298k_atomic_b5=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_298k_atomic_b5_um=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_298k_atomic_b5_um_ci=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_298k_atomic_b6=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_298k_atomic_b6_um=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_298k_atomic_b6_um_ci=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_298k_eccsd=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_298k_eccsd_um=>Properties_ScalarMolecularProperty,
                :enthalpy_of_formation_298k_eccsd_um_ci=>Properties_ScalarMolecularProperty,
                :zpe_atomic=>Properties_ScalarMolecularProperty,
                :zpe_atomic_um=>Properties_ScalarMolecularProperty,
                :zpe_atomic_um_ci=>Properties_ScalarMolecularProperty,
                :number_imaginary_frequencies=>Int32,
                :number_of_optimization_runs=>Int32,
                :nuclear_repulsion_energy=>Properties_ScalarMolecularProperty,
                :diagnostics_d1_ccsd_2sp=>Properties_ScalarMolecularProperty,
                :diagnostics_d1_ccsd_2sd=>Properties_ScalarMolecularProperty,
                :diagnostics_d1_ccsd_3psd=>Properties_ScalarMolecularProperty,
                :diagnostics_t1_ccsd_2sp=>Properties_ScalarMolecularProperty,
                :diagnostics_t1_ccsd_2sd=>Properties_ScalarMolecularProperty,
                :diagnostics_t1_ccsd_3psd=>Properties_ScalarMolecularProperty,
                :diagnostics_t1_ccsd_2sp_excess=>Properties_ScalarMolecularProperty,
                :calculation_statistics=>Base.Vector{Properties_CalculationStatistics},
...
function meta(::Type{Conformer})
    ProtoBuf.metalock() do
        if !isassigned(__meta_Conformer)
            ...
            allflds = Pair{Symbol,Union{Type,String}}[
                :conformer_id=>Int32,
                :original_conformer_index=>Int32,
                :initial_geometries=>Base.Vector{Geometry},
                :optimized_geometry=>Geometry,
                :duplicated_by=>Int32,
                :duplicate_of=>Base.Vector{Int32},
                :properties=>Properties,
                :bond_topologies=>Base.Vector{BondTopology},
                :fate=>Int32,
            ]
            meta(
                target,
    ...
    ProtoBuf.metalock() do
        if !isassigned(__meta_BondTopologySummary)
            ...
            allflds = Pair{Symbol,Union{Type,String}}[
                ...
                :count_attempted_conformers=>Int32,
                :count_duplicates_same_topology=>Int32,
                :count_duplicates_different_topology=>Int32,
                :count_failed_geometry_optimization=>Int32,
                :count_kept_geometry=>Int32,
                :count_missing_calculation=>Int32,
                :count_calculation_with_error=>Int32,
                :count_calculation_success=>Int32,
                :count_detected_match_with_error=>Int32,
                :count_detected_match_success=>Int32,
            ]
            meta(
                target,
                BondTopologySummary,
...
export AvailabilityEnum,
    BondTopology_AtomType,
    BondTopology_BondType,
    BondTopology_Bond,
    BondTopology,
    TopologyMatches,
    Geometry_AtomPos,
